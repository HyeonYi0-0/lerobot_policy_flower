...
class ActionIndex:
    ...
    def __init__(self):
        self.action_spaces = {
            'joint_single': 0,   # single-arm joint position, 8D
            'eef_delta': 1,      # single-arm end-effector velocity, 7D
            'bimanual_nav': 2,   # bimanual + navigation, 16D
            'dual_lerobot': 3,   # dual-arm LeRobot joint position, 12D
        }
